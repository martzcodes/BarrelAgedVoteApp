...
module.exports = function(app) {
  ...
  app.post('/auth/users', auth.ensureAuthenticated, users.create);
  app.get('/auth/users/delete', auth.ensureAuthenticated, users.reset);
  ...
  app.get('/auth/votes/import', auth.ensureAuthenticated, votes.import);
  ...
  app.post('/auth/votes/update', votes.update);
